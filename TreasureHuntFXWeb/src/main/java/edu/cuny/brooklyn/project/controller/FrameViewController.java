...
public class FrameViewController {
	...
	void newGame(ActionEvent event) {
		LOGGER.debug("openning a new game: not implemented yet");
	}
	...
	@FXML
	void pullFromWeb(ActionEvent event) {
		LOGGER.debug("Pull game statistics from the Web: not implemented yet");
		/*
		 * GameMetricsWebAgent webAgent = new GameMetricsWebAgent();
		 * GameMetrics metrics = webAgent.pullGameMetricsFromWeb();
		 * show game metrics
		 */
	}

	@FXML
	void pushToWeb(ActionEvent event) {
		LOGGER.debug("Push key game statistics to the Web: not implemented yet");
		/*
		 * GameMetricsWebAgent webAgent = new GameMetricsWebAgent();
		 * GameMetrics metrics = GameMetrics.fromGameStatistics(gameStatitics);
		 * webAgent.pushMetricsToWeb(metrics);
